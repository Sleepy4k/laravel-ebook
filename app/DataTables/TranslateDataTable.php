...
class TranslateDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\TranslateDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TranslateDataTable $model): QueryBuilder
    {
